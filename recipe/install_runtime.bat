...
IF NOT EXIST "%BT_ROOT%\VC\Tools\MSVC\%runtime_version%" (
   echo ============================================================================================
   ...
   set "out=!out! to reflect the current value of the installed version.  See %BT_ROOT%\VC\Tools\MSVC\ for installed versions."
   echo !out!
   echo ============================================================================================
   exit 1
   )
